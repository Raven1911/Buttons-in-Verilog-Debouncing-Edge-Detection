...
HD_PWD='D:/Project GIT/Buttons_Debouncing_and_Edge Detection/Buttons_Debouncing_Edge_Detection/Buttons_Debouncing_Edge_Detection.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log debouncer_delayed.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source debouncer_delayed.tcl -notrace
