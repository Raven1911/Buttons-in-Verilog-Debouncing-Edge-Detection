...
HD_PWD='D:/Project GIT/Buttons_Debouncing_and_Edge Detection/Buttons_Debouncing_Edge_Detection/Buttons_Debouncing_Edge_Detection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debouncer_delayed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debouncer_delayed.tcl
